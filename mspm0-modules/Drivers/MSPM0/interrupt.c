...
void UART_BNO08X_INST_IRQHandler(void) {
  ...
  if ((rxSize == 19) && (bno08x_dmaBuffer[0] == 0xAA) &&
    ...
    bno08x_data.yaw =
        (int16_t)((bno08x_dmaBuffer[4] << 8) | bno08x_dmaBuffer[3]) / 100.0;
    bno08x_data.pitch =
        (int16_t)((bno08x_dmaBuffer[6] << 8) | bno08x_dmaBuffer[5]) / 100.0;
    bno08x_data.roll =
        (int16_t)((bno08x_dmaBuffer[8] << 8) | bno08x_dmaBuffer[7]) / 100.0;
    ...
    if ((wit_dmaBuffer[packCnt * 11] == 0x55) &&
      ...
      if (wit_dmaBuffer[packCnt * 11 + 1] == 0x51) {
        ...
        wit_data.temperature =
            (int16_t)((wit_dmaBuffer[packCnt * 11 + 9] << 8) |
